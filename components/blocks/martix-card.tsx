...
export const MatrixCard = () => {
  return (
    <div className="relative  flex h-full w-full items-center opacity-60 justify-center overflow-hidden rounded-lg  bg-background">
      <MatrixRain fixedColor="#fff" speed={100} className="absolute left-1" />
