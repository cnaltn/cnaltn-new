...
export function GlobeCard({
  ...
  return (
    <div className="relative flex size-full max-w-lg items-center justify-center overflow-hidden rounded-lg   ">
      <span className="pointer-events-none bg-linear-to-b from-black to-gray-300/80 bg-clip-text text-center text-2xl md:text-6xl leading-none font-semibold whitespace-pre-wrap text-transparent dark:from-white dark:to-slate-900/10">
        {text}
      </span>
      <Globe className="top-0 opacity-80" markerColor={markerColor} />
